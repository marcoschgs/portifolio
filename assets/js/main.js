  ...
  function activateAnimation() {
    ...
    progressBarElements.forEach(function(progressBar) {
      if (progressBar.style.opacity === '0') {
        progressBar.style.animation = 'progresss 0.6s ease-in-out forwards';
        progressBar.style.opacity = '1';
      }
    });
  }

  // Adiciona o ouvinte de foco à seção
  var skillSection = document.getElementById('about');
  skillSection.addEventListener('focus', activateAnimation);
